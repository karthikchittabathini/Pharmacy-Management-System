...
namespace Pharmacy_Management_System.Controllers
{
    ...
    public class EmailProcessController : ControllerBase
    {
        ...
        public IActionResult EmailSending(List<Order> data_table)
        {
            ...
            message.From.Add(new MailboxAddress("chittabathini karthik", "vtu14218@veltech.edu.in"));
            ...
            using(var client = new SmtpClient())
            {
                ...
                client.Authenticate("vtu14218@veltech.edu.in", "passsword");
                client.Send(message);
        ...
        public IActionResult AdminEmailSending(Order data_table)
        {
            ...
            {
                client.Connect("smtp.gmail.com", 587, false);
                client.Authenticate("vtu14218@veltech.edu.in", "password");
                client.Send(message);
                client.Disconnect(true);
            }
